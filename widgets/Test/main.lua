...
-- VISUAL LIFT MODEL:
--
--   GV2 blade working depth = full visual blade-down position
--   GV3 tiller groom depth  = full visual tiller-down position
--
-- SIDE BLADE:
--   * line-built blade so angle can animate
--   * angle zero = vertical
--   * working depth = bottom aligned with track bottom
--
-- SIDE TILLER:
